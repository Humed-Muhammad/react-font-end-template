    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-slate-900 dark:to-indigo-900 ">
      ...
      >
        ...
        >
          {addedEnhancement?.map((stat) => (
            <motion.div
              ...
              className="group"
            >
              <Card className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border-0 shadow hover:shadow-md transition-all duration-300">
        ...
        <AnimatePresence>
          {showFilters && (
            <motion.div
              ...
              variants={itemVariants}
            >
              <Card className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm border-0 shadow">
                <CardContent className="p-6">
        ...
        <motion.div variants={itemVariants}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {products?.map((product, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <Card className="bg-white/60 p-0 dark:bg-gray-800/60 backdrop-blur-sm border-0 shadow hover:shadow-md transition-all duration-300 overflow-hidden">
          ...
          {viewMode === "table" && (
            <Card className="bg-white/60 p-0 pb-2 dark:bg-gray-800/60 backdrop-blur-sm border-0 shadow">
